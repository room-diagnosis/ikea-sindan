...
family:{
A:{title:"Organic Essence Lover",desc:"自然のぬくもりと、シンプルで心地よい暮らしを大切にする人\n素材そのものの良さや、肌に触れる質感に敏感な「本質」を知っているタイプ。\n木の温もりや柔らかな曲線に囲まれることで、心のリズムを自然と整えられる人です。\n流行に左右されず、自分が本当に「心地よい」と感じるものを長く大切にする、誠実な感性の持ち主です。",img:"写真/画像1.jpg",url:""},
B:{title:"Colorful Story Lover",desc:"色や遊び心で、毎日を自分らしく彩る人\n• お部屋を自分という物語を表現する「キャンバス」のように捉え、自由に楽しむタイプ。\n鮮やかな色やユニークな小物をミックスして、日常の中に小さな感動やワクワクを自分自身で創り出せる人です。\n既存のルールに縛られない自由な発想を持ち、周りの人まで明るくするようなエネルギッシュな魅力に溢れています。",img:"写真/画像2.jpg",url:""},
C:{title:"Deep Comfort Lover",desc:"落ち着いた空間で、深いくつろぎの時間を楽しむ人\n 喧騒から離れ、静寂や「凪」の時間を何よりも贅沢だと感じられるタイプ。\nシックな色使いや落ち着いた照明の中で、一日の終わりに自分自身を深く癒やす術を知っている人です。\n落ち着きと品格を兼ね備え、細部にまでこだわりを宿らせることで、上質な「大人の休日」を演出できる達人です。",img:"写真/画像3.jpg",url:""}
},

one:{
A:{title:"Pure Modern Lover",desc:"真っ白なキャンバスに思考を広げ、クリアな毎日を整える人\n無駄を削ぎ落とした空間で、自分のやりたいことに真っ直ぐ集中できるタイプ。\n思考をリセットできる白の魔法を使いこなし、常に「今の自分」をアップデートし続けるスマートな感性の持ち主です。",img:"写真/画像4.jpg",url:""},
B:{title:"Joyful Mood Lover",desc:"お気に入りの色や物に囲まれ、日常にワクワクを灯す人\n部屋をただの場所ではなく、自分のエネルギーを充電する「パワースポット」に変えられるタイプ。\n直感を大切に、好きなものに囲まれて笑いながら過ごす、自由でポジティブな心の持ち主です。",img:"写真/画像5.jpg",url:""},
C:{title:"Soft Navy Lover",desc:"静かな時間の深みと、心に寄り添う柔らかさを知っている人\n落ち着いた色味の中に、自分だけのこだわりや優しさをそっと忍ばせるタイプ。\n派手さよりも「質の良さ」や「こなれ感」を大切にし、穏やかな時間の流れを贅沢に味わえる、大人の余裕の持ち主です。",img:"写真/画像6.jpg",url:""}
}
...
/* Xシェア */
const shareText="あなたのIKEAインテリアタイプは "+result.title+" でした！";
